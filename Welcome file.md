...
<h1 id="mitchell-van-zuijlen">Mitchell van Zuijlen</h1>
<h3 id="researcher-psychologist-developer-and-all-round-nerd">Researcher, Psychologist, Developer and all-round Nerd</h3>
<p>Hi! I’m a cognitive psychologist, currently working in the field of human material perception. I’ve always been facinated by the human brain and the way we see and perceive the world around us. I enjoy using technology and aim for innovative solutions in my work. I draw energy from designing and creating my own experiments, programs and tools. Self-improvement is - and always has been - important to me; I’m motivated to be the best I can be. As a result, I don’t shy away from learning new things… I enjoy learning and I love the thrill of discovery and if there’s one word to describe me, it’s curious.</p>
<h2 id="my-skills">My Skills?</h2>
<h5 id="researcher">Researcher</h5>
<p>I have a background in pyschology, where I was always interestesed in perception. I am currently working in the field of human visual perception, with a focus on material perception. My natural curiosity, combined with my analytical mindset keeps me commited and motivated to make my mark in this field. I like encorperating technology into my research, as illustrated by my self-taught experience with programming and coding.</p>
<h5 id="developer">Developer</h5>
<p>I am a competent coder and have written code used in a variety of projects such as Virtual Reality experiments, fMRI- EEG- and EMG-studies as well as big-data projects that work with citizen scientists over the internet. I have a preference for using Python, but depending on the project I’m comfortable with using Matlab and JavaScript (and html,css). If need be, I can work and change some C source-code .</p>
<h5 id="languages">Languages</h5>
<p>I’m a native dutch speaker, I’m fluent in English and I usually manage to order the right food in German, French and Spanish.</p>
<h2 id="research">Research</h2>
<h1 id="a-collapsible-section-containing-code">A collapsible section containing code</h1>

  Click to expand!
<pre class=" language-javascript"><code class="prism  language-javascript">  <span class="token keyword">function</span> <span class="token function">whatIsLove</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'Baby Don'</span>t hurt me<span class="token punctuation">.</span> Don<span class="token string">'t hurt me'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token keyword">return</span> <span class="token string">'No more'</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
</code></pre>

<h5 id="papers">Papers</h5>
<ul>
<li>M.j.p. van Zuijlen, (2019) in press</li>
<li>M.j.p. van Zuijlen, (2019) in press</li>
</ul>
<h5 id="talks">Talks</h5>
<ul>
<li>
<p>van Zuijlen, M.J.P. , Lin, H., Upchurch, P., Bala, Kavita., Pont, S., Wijntjes, M. W.A.  Has the depiction of the human face changed over the centuries? <em>The Visual Science of Art Conference (VSAC)</em>. Trieste, Italy.  August, 2018.</p>
</li>
<li>
<p>van Zuijlen, M.J.P. , Lin, H., Upchurch, P., Bala, Kavita., Pont, S., Wijntjes, M. W.A.  The influence of scene context on perception of material properties. <em>The Skin of Things (TSOT)</em>. Amsterdam, The Netherlands.  November, 2018.</p>
</li>
<li>
<p>van Zuijlen, M.J.P. , Lin, H., Upchurch, P., Bala, Kavita., Pont, S., Wijntjes, M. W.A.  Perceptual qualities of things. <em>Perception Day.</em> Nijmegen, The Netherlands.  December, 2018.</p>
</li>
<li>
<p>van Zuijlen, M.J.P. .,Pont, S, Wijntjes, M. W.A. Material property space analysis for depicted materials. <em>Visual Science Society (VSS)</em>. Flordia, USA.  May, 2019.</p>
</li>
</ul>
<h5 id="posters">Posters</h5>
<ul>
<li>
<p>van Zuijlen, M.J.P. ,Pont, S, Wijntjes, M. W.A. Depicted material categories in online museum collections. The Visual Science of Art Conference (VSAC). Berlin, Germany.  August, 2017.</p>
</li>
<li>
<p>van Zuijlen, M.J.P. ,Pont, S, Wijntjes, M. W.A. Human classification of depicted materials in paintings. European Conference on Visual Perception (ECVP). Berlin, Germany.  August, 2017.</p>
</li>
<li>
<p>Hurlbert, A.,  van Zuijlen, M.J.P. , Spoiala, C., Wijntjes, M. W.A. Painting the time of day: colour determines perceived circadian phase in visual art. The Visual Science of Art Conference (VSAC). Trieste, Italy.  August, 2018.</p>
</li>
<li>
<p>van Zuijlen, M.J.P. , di Cicco, F.,Pont, S, Wijntjes, M. W.A. Material cues from the past: Experimentally testing a historical description of material rendering. European Conference on Visual Perception (ECVP). Trieste, Italy.  August, 2018.</p>
</li>
<li>
<p>van Zuijlen, M.J.P. .,Pont, S, Wijntjes, M. W.A. Material Incidence and spatial analysis of materials in Visual Pre-Modern Art. The Visual Science of Art Conference (VSAC). Leuven, Belgium.  August, 2019.</p>
</li>
<li>
<p>van Zuijlen, M.J.P. .,Pont, S, Wijntjes, M. W.A. Relations between material classes and material attributes. European Conference on Visual Perception (ECVP). Leuven, Belgium.  August, 2019.</p>
</li>
</ul>
